...
my $cmd="parallel -j $snc bedtools intersect -abam $inf/{1}*.bam -b $refgr -v \'\>\' $outf/{1}_repeatmasked.bam ::: @nms";
`parallel -j $snc bedtools intersect -abam $inf/{1}_*.bam -b $refgr -v \'\>\' $outf/{1}_repeatmasked.bam ::: @nms`;
